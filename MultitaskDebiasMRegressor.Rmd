...
<br><br>
<center> <h1> debiasm.<span style="color:#DD4814">**MultitaskDebiasMRegressor**</span></h1> </center>
<br>
<style>
.codecell {
  background-color: #A1DDF2;
...
<div class="codecell">
*class* debiasm.<span style="color:#DD4814">**MultitaskDebiasMRegressor**</span>(batch_str = 'infer',<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                learning_rate=0.005, <br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                min_epochs=25,<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                l2_strength=0,<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                w_l2=0,<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                random_state=None,<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                x_val=None,<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&ensp;                prediction_loss=torch.nn.functional.mse_loss<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp; &emsp;&emsp;&emsp;&emsp;&ensp;)
</div>

<br>
The Multitask DEBIAS-M Regressor. <br> <br>
This class implements multiplicative bias-correction via DEBIAS-M for a multitask regressor. It received as input an `X` matrix of n_samples \times n_taxa read count or relative abundancees from multiple microbiome samples, along with continuous regression target `y` for at least two tasks. <br> <br>
...
* <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
* <span style="color:#DD4814">prediction_loss: loss function, default=torch.nn.functional.mse_loss</span>
...
from debiasm import MultitaskDebiasMRegressor
...
## Assess resulting predictions
predicted_values = multitask_model.predict(X_val)
   ...
   *  Fit the model according to the given training data.
    * <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
      * <span style="color:#DD4814"><u>Parameters</u>:</span>
        ...
        * <span style="color:#DD4814">y : array-like of shape (n_samples, n_tasks)</span>
...
* <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
   ...
   * <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
      ...
      * <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
      * <span style="color:#DD4814"><u>Returns</u>:</span>
        * <span style="color:#DD4814">X_debias</span> :  matrix of shape (n_samples, n_taxa)
            * The relative abundance matrix of X following bias-correction
</div>

<div class="codecell">
* <span style="color:#DD4814">predict</span>(X)
* <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
   *  Calculate DEBIAS-M prediction values.
   * <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
      * <span style="color:#DD4814"><u>Parameters</u>:</span>
        * <span style="color:#DD4814">X : {array-like, sparse matrix} of shape (n_samples, 1 + n_taxa)</span>
      ...
      * <hr style="height: 2.5px; border: 1px solid #987CAC; background-color: #987CAC; margin: 2px">
      * <span style="color:#DD4814"><u>Returns</u>:</span>
        * <span style="color:#DD4814">P : list of n_tasks ndarrays, each of shape (n_samples)</span>
            * The regression predictions of each sample for each task considered in the model.
</div>
...
<br>
For more background on DEBIAS-M, refer to [our manuscript](https://doi.org/10.1038/s41564-025-01954-4). 
