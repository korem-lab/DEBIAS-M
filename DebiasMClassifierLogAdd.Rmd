...
<br><br>
<center> <h1> debiasm.<span style="color:#DD4814">**DebiasMClassifierLogAdd**</span></h1> </center>
<br>
<style>
.codecell {
  background-color: #A1DDF2;
...
<div class="codecell">
*class* debiasm.<span style="color:#DD4814">**DebiasMClassifierLogAdd**</span>(batch_str = 'infer',<br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&ensp;                learning_rate=0.005, <br>
  &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&ensp;                min_epochs=25,<br>
...
This class implements additive DEBIAS-M bias-correction, which models the processing-bias mechanism in logarithmic space representations of read counts, such as the center log ratio transform.<br>

This uses a microbiome n_samples \times n_taxa of some logarithmic processed read count matrices from multiple `X` samples, along with a provided binary `y` label.
