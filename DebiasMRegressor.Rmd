...
This class implements multiplicative DEBIAS-M bias-correction using aggregated microbiome n_samples \times n_taxa read count matrices from multiple `X` samples, along with a provided regression target `y`. It can handle both read count and relative abundance inputs. <br> <br>
