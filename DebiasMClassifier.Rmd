...
<br><br>
<center> <h1> debiasm.<span style="color:#DD4814">**DebiasMClassifier**</span></h1> </center>
<br>
<style>
.codecell {
  background-color: #A1DDF2;
...
<div class="codecell">
*class* debiasm.<span style="color:#DD4814">**DebiasMClassifier**</span>(batch_str = 'infer',<br>
...
This class implements multiplicative bias-correction via DEBIAS-M for a binary classifier. It received as input an `X` matrix of n_samples \times n_taxa read count or relative abundancees from multiple microbiome samples, along with a binary `y` label. <br> <br>
